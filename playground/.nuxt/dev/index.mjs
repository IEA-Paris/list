...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler as lazyEventHandler$1, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/destr/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/vue/index.mjs';
import { walkResolver } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/errx/dist/index.js';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/bob/Projects/seed/modules/list/node_modules/ipx/dist/index.mjs';
import { lazyEventHandler, useBase } from 'file:///home/bob/Projects/seed/modules/list/node_modules/h3/dist/index.mjs';
import { isAbsolute } from 'file:///home/bob/Projects/seed/modules/list/node_modules/pathe/dist/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/bob/Projects/seed/modules/list/playground/node_modules/unhead/dist/plugins.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/bob/Projects/seed/modules/list/playground/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/bob/Projects/seed/modules/list/playground","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/bob/Projects/seed/modules/list/playground/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/bob/Projects/seed/modules/list/playground/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/bob/Projects/seed/modules/list/playground/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/bob/Projects/seed/modules/list/playground/.data/kv"}));
...
const _4NkO006A7RGGq9sAv84sRxwqeTStCai5I2E862rhE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/bob/Projects/seed/modules/list/playground";
...
const _E0eL3LDKx1xkeAprqFQr8kXom9TgqEfFDOSSspGoC8 = (nitroApp) => {
...
const plugins = [
  _4NkO006A7RGGq9sAv84sRxwqeTStCai5I2E862rhE,
_E0eL3LDKx1xkeAprqFQr8kXom9TgqEfFDOSSspGoC8
];
...
const _HyjRsw = lazyEventHandler(() => {
...
const _lazy_AKvJ9a = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_AKvJ9a, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _HyjRsw, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_AKvJ9a, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///home/bob/Projects/seed/modules/list/playground/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/bob/Projects/seed/modules/list/playground/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
